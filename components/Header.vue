<template>
    <header class="header border-b-[1px] py-[16px]">
        <div class="container flex justify-between items-center">
            <nuxt-link to="/" class="text-gray-800 text-3xl font-serif font-bold">
                ChatRoom
            </nuxt-link> 
            <div>
                <input type="text" placeholder="Search" class="py-[2px] px-[8px] border-2">
            </div>
